...
const UserReducer = (state = initialState, action = {}) => {
  ...
  switch (action.type) {
    ...
    case ActionTypes.UPDATE_FIRST_NAME:
      console.log('in update switch', { ...state, firstName: action.payload });
      return { ...state, firstName: action.payload };
    case ActionTypes.FETCH_FIRST_NAME:
      console.log('in fetch switch', { ...state, firstName: action.payload });
      return { ...state, firstName: action.payload };
    default:
      return state;
  }
